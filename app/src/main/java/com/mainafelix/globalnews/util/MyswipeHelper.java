...
//            RecyclerView.ViewHolder swipeVewBuilder = recyclerView.findViewHolderForAdapterPosition(swipePosition);
//            View swipedItem = myswipeViewH.itemview;//viewholder
//            Rect rect = new Rect();
...
//            return false;
//        }
//        private onDraw(Canvas c,RectF rectF,int pos){
//            Paint p = new Paint();
//            p.setColor(color);
//            c.drawRect(rectF,p);
